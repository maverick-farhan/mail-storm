<div class="bg-black py-4 md:py-1 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-4xl sm:text-center">
        <h2 class="text-5xl font-bold tracking-tight text-gray-200 sm:text-4xl">Simple no-tricks pricing</h2>
        <p class="mt-6 text-lg leading-8 text-gray-400">We have decided to make a very simple pricing model, prevent our users to face any dilemma.</p>
      </div>
      <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
        <div class="p-8 sm:p-10 lg:flex-auto">
          <h3 class="text-2xl font-bold tracking-tight text-gray-200">Monthly Subscription</h3>
          <p class="mt-6 text-base leading-7 text-gray-400">Simple, transparent and straight forward pricing with no hidden charges.</p>
          <div class="mt-10 flex items-center gap-x-4">
            <h4 class="flex-none text-sm font-semibold leading-6 text-blue-400">What’s included</h4>
          ...
          <ul role="list" class="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-200 sm:grid-cols-2 sm:gap-6">
            <li class="flex gap-x-3">
              ...
              Fast &amp; Relaible API support
            </li>
            <li class="flex gap-x-3">
              <svg class="h-6 w-5 flex-none text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" />
              </svg>
              Build Unlimited Emails
            </li>
            <li class="flex gap-x-3">
              <svg class="h-6 w-5 flex-none text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" />
              </svg>
              Send Unlimited Emails to your customers
            </li>
            <li class="flex gap-x-3">
              <svg class="h-6 w-5 flex-none text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" />
              </svg>
              Integrate fast and explore features with  &infin;/day emails
            </li>
            <li class="flex gap-x-3">
              <svg class="h-6 w-5 flex-none text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" />
              </svg>
              Free Database access to store customers email
            </li>
          </ul>
        </div>
        <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
          <div class="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
            <div class="mx-auto max-w-xs px-8">
              <p class="text-base font-semibold text-gray-600">Only Subscription you need</p>
              <p class="mt-6 flex items-baseline justify-center gap-x-2">
                <span class="text-5xl font-bold tracking-tight text-gray-900">&#8377;Free/mo</span>
                <span class="text-sm font-semibold leading-6 tracking-wide text-gray-600">INR</span>
              </p>
              <a href="#" class="mt-10 block w-full rounded-md bg-blue-700 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Get access</a>
  ...
  <div class="main p-5 bg-light-blue">

  <div class="flex justify-center items-start my-2 mx-auto mt-16 max-w-2xl rounded-3xl sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
    <div class="w-full sm:w md:w my-1">
      <h2 class="text-3xl font-semibold text-white mb-2">Frequently asked questions</h2>
      <ul class="flex flex-col">
        <li class="bg-white my-2 rounded shadow-lg" x-data="accordion(1)">
          <h2
            @click="handleClick()"
          ...
          >
            ...
            <svg
              :class="handleRotate()"
              class="fill-current text-black h-6 w-6 transform transition-transform duration-500"
              viewBox="0 0 20 20"
            >
          ...
          <div
            x-ref="tab"
            :style="handleToggle()"
            class="border-l-2 border-blue-800 text-black overflow-hidden max-h-0 duration-500 transition-all"
          >
            <p class="p-3 bg-gray-100 text-gray-900">
        ...
        <li class="bg-white rounded my-2 shadow-lg" x-data="accordion(4)">
          ...
          <div
            class="border-l-2 text-black border-blue-800 overflow-hidden max-h-0 duration-500 transition-all"
            x-ref="tab"
            :style="handleToggle()"
          >
            <p class="p-3 bg-gray-100 text-gray-900">
